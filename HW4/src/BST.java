...
public class BST<E extends Comparable<E>> implements Tree<E> {
    ...
    private boolean isEqualTo(TreeNode<?> root1, TreeNode<?> root2) {
        if (root1 == null || root2 == null)
            return root1 == root2;
        boolean elementsMatch = Objects.equals(root1.element, root2.element); // compare without NullPointerException
        boolean leftMatch = isEqualTo(root1.left, root2.left); // recursive call
        boolean rightMatch = isEqualTo(root1.right, root2.right); // recursive call
        return elementsMatch && leftMatch && rightMatch;
    }
